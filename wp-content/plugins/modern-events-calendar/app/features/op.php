...
class MEC_feature_op extends MEC_base
{
    ...
    public function init()
    {
        ...
        if($booking_status)
        {
            ...
            $this->factory->action('mec_organizer_payment_fields', array($this, 'meta_box_op'), 25);
    ...
    public function meta_box_op($post)
    {
        ...
        if(!is_array($op_options)) $op_options = [];
        ...
        <div id="mec-organizer-payments">
            <div class="mec-meta-box-fields mec-booking-tab-content" id="mec_meta_box_op_form">
                <h4 class="mec-title"><?php esc_html_e('Organizer Payment Credentials', 'mec'); ?></h4>
    ...
    public function op($options, $gateway_id, $transaction_id)
    {
        ...
        $gateway_op = isset($op[$gateway_id]) ? $op[$gateway_id] : [];
