...
class MEC_feature_schema extends MEC_base
{
    ...
    public function meta_box_schema($post)
    {
        ...
        <div class="mec-meta-box-fields mec-event-tab-content" id="mec-schema">
            ...
            <p><?php esc_html_e("Following statuses are for informing search engines (Google, bing, etc) about your events so they can manage your events better. Therefore you can use these statuses to be more Search Engine Friendly.", 'mec'); ?></p>
