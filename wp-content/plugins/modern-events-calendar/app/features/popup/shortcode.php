...
<div id="mec_popup_shortcode" class="lity-hide">
    ...
    <div class="mec-steps-panel">
            ...
            <div class="mec-steps-content-container">
                    ...
                    <div class="mec-styles-wrapper">
                        <div class="mec-skin-styles mec-styles-list">
                            <label class="active">
                                ...
                                <div><?php esc_html_e('Classic', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Minimal', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Modern', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Standard', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Toggle', 'mec'); ?></div>
                            </label>
                            ...
                            <label>
                                ...
                                <div><?php esc_html_e('Fluent', 'mec'); ?></div>
                            </label>
                            <?php } ?>
                        </div>
                        <div class="mec-skin-styles mec-styles-grid">
                            ...
                            <label>
                                ...
                                <div><?php esc_html_e('Clean', 'mec'); ?></div>
                            </label>
                            <label>
                            ...
                            <label>
                                ...
                                <div><?php esc_html_e('Simple', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Colorful', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Novel', 'mec'); ?></div>
                            </label>
                            <?php if ( is_plugin_active( 'mec-fluent-layouts/mec-fluent-layouts.php' ) ) { ?>
                            <label>
                        ...
                        <div class="mec-skin-styles mec-styles-full_calendar">
                            <h3><?php esc_html_e('Monthly Style', 'mec'); ?></h3>
                            <label class="active">
                        ...
                        <div class="mec-skin-styles mec-styles-cover">
                            ...
                            <label>
                                ...
                                <div><?php esc_html_e('Fluent Type 1', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Fluent Type 2', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Fluent Type 3', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Fluent Type 4', 'mec'); ?></div>
                            </label>
                            <?php } ?>
                        </div>
                        <div class="mec-skin-styles mec-styles-countdown">
                            <label class="active">
                                ...
                                <div><?php esc_html_e('Style 1', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Style 2', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Style 3', 'mec'); ?></div>
                            </label>
                            <?php if ( is_plugin_active( 'mec-fluent-layouts/mec-fluent-layouts.php' ) ) { ?>
                            <label>
                        ...
                        <div class="mec-skin-styles mec-styles-carousel">
                            <label class="active">
                                ...
                                <div><?php esc_html_e('Type 1', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Type 2', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Type 3', 'mec'); ?></div>
                            </label>
                            <label>
                                ...
                                <div><?php esc_html_e('Type 4', 'mec'); ?></div>
                            </label>
                            <?php if ( is_plugin_active( 'mec-fluent-layouts/mec-fluent-layouts.php' ) ) { ?>
                            <label>
                        ...
                        <div class="mec-skin-styles mec-styles-slider">
                            ...
                            <label>
                                ...
                                <div><?php esc_html_e('Type 5', 'mec'); ?></div>
                            </label>
                            <?php if ( is_plugin_active( 'mec-fluent-layouts/mec-fluent-layouts.php' ) ) { ?>
                            <label>
                        ...
                        ?>
                        <h3 for="mec_shortcode_custom_style"><?php esc_html_e('Select Style', 'mec'); ?></h3>
                ...
                <div class="mec-steps-content mec-steps-content-4">
                    <div class="mec-multiple-skin-options">
                        <h3><?php esc_html_e('Single Event Display Method', 'mec'); ?></h3>
                        <div>
                            <label>
                                <input type="radio" name="shortcode[sed]" value="0" checked>
                                <?php esc_html_e('Current Window', 'mec'); ?>
                            </label>
                            <label class="active">
                                <input type="radio" name="shortcode[sed]" value="new" checked>
                                <?php esc_html_e('New Window', 'mec'); ?>
                            </label>
                            <label>
                                <input type="radio" name="shortcode[sed]" value="m1">
                                <?php esc_html_e('Modal Popup', 'mec'); ?>
                            </label>
                        </div>
                    </div>
                    <div class="mec-single-skin-options">
                        <h3 for="mec_shortcode_event_id"><?php esc_html_e('Select Event', 'mec'); ?></h3>
                ...
                <div class="wns-be-group-tab mec-steps-content mec-steps-content-5">
                    <div class="mec-switcher" id="mec_show_past_events_wrapper">
                        <div>
                            ...
                            <p class="description"><?php esc_html_e('You have ability to include past/expired events if you like so it will show upcoming and expired events based on start date that you selected.', 'mec'); ?></p>
                        </div>
                        <div>
                    ...
                    <div class="mec-switcher" id="mec_show_only_past_events_wrapper">
                        <div>
                            ...
                            <p class="description" style="color: red;"><?php echo sprintf(esc_html__('It shows %s expired/past events.', 'mec'), '<strong>'.esc_html__('only', 'mec').'</strong>'); ?></p>
                        </div>
                        <div>
                    ...
                    <div class="mec-switcher" id="mec_show_only_ongoing_events_wrapper">
                        <div>
                            ...
                            <p class="description"><?php esc_html_e('It shows only ongoing events on List and Grid skins.', 'mec'); ?></p>
                        </div>
                        <div>
                ...
                <div class="mec-steps-content mec-steps-content-6">
                    ...
                    <div class="mec-steps-6-results">
                        <div class="mec-popup-shortcode">
                            <h3><?php esc_html_e('Your Shortcode', 'mec'); ?></h3>
                            <div class="mec-popup-shortcode-code">
                                <code></code>
                                <button type="button" class="mec-button-copy"><?php esc_html_e('Copy', 'mec'); ?></button>
                            </div>
                        </div>
                        <p class="description"><?php esc_html_e('Put this shortcode into your desired page.', 'mec'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="mec-next-previous-buttons">
            ...
            <button class="mec-button-new"><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-new-shortcode-plus.svg'; ?>" /><?php esc_html_e('New Shortcode', 'mec'); ?></button>
        </div>
    </div>
</div>
